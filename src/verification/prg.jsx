...
<form onSubmit={send} className={styles.main}>
  <div>
    ...
    <div onClick={()=> Router("/mailVerification/prg",{state: {ip:ip,uid:uid}})} style={{color:"red",textDecoration:"none",paddingLeft:"12px"}} shallow><p>Sem acesso ao seu celular? Confirme por e-mail</p></div>
    </div>
  ...
  <div className={styles.main}>
    ...
    <div className={styles.content}>
      <div className={styles.contentBox2}>
        ...
        <p className={styles.message2}>O código de verificação expirará em 3 minutos.</p>
        </>)}
        <br />
        {show && ( <p className={styles.message}> O código expirou. Por favor, insira o novo código de segurança que acabou de ser enviado para a sua caixa de SMS</p> )}
