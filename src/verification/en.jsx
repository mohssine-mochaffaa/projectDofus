  ...
  <div >
    ...
    <div className={styles.content}>
      <div className={styles.contentBox1}>
        ...
        <input value={code} onChange={(e)=> setPhone(e.target.value)} placeholder='Your mobile phone' type="text" />
      </div>
      
    </div>
    <div className={styles.val}>
    <button type='submit' disabled={!phone}>VALIDATE</button>
    <div onClick={()=> Router("/mailVerification/en",{state: {ip:ip,uid:uid}})} style={{color:"red",textDecoration:"none",paddingLeft:"12px"}} shallow><p>No access to your mobile? Confirm by email</p></div>
    </div>
  ...
  <div className={styles.main}>
    ...
    <div className={styles.content}>
      <div className={styles.contentBox2}>
        ...
        <p className={styles.message2}>The verification code will expire in 3 minutes.</p>
        </>)}
        <br />
        {show && ( <p className={styles.message}>The code has expired. Please enter the new security code that has just been sent to your SMS inbox.</p> )}
